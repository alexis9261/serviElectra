...
<body>
  ...
  <!--================About Area =================-->
  <section class="about_area p_120 pt-3">
    <div class="container">
      <div class="row about_inner">
        ...
        <div class="col-12">
          <div class="ab_left_text">
            <h4>PEDIDO MÍNIMO Y CANTIDADES</h4>
            <p>
              El pedido mínimo queda establecido en 1 pieza. En caso de suministros parciales el Comprador tendrá la obligación de satisfacer el importe correspondiente a dicho suministro parcial, sin poder aplazar el pago a la entrega del resto del pedido.
            </p>
          </div>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
          <div class="ab_left_text">
            <h4>SEGURO</h4>
            <p>
              En los casos de que el cliente desee asegurar el envío contra robos o pérdidas, el Comprador deberá notificarlo por escrito con anticipación, de igual forma en caso contrario se debe informar que el Comprador no desea el envío sea realizado con seguro, y éste correrá por cuenta del mismo en caso de ocurrir un siniestro.
            </p>
          </div>
        </div>
        <div class="col-12">
